...
# -*- coding: utf-8 -*-
# vim:fenc=utf-8
# Copyright © 2020 OmniVector Solutions admin@omnivector.solutions
...
import ops
import ops.main
from src.charm import SlurmctldCharm
...
class OperatorTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        charm = SlurmctldCharm(framework, None)
        self.charm = charm
    ...
    def get_notice_count(self, hook):
        ...
        notice_count = 0
        handle = "SlurmctldCharm/on/{}".format(hook)
